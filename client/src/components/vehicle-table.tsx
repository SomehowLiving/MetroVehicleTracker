...
//   const filteredVehicles = activeVehicles?.filter((vehicle: any) => {
//     const matchesStore = !filters.store || vehicle.storeId.toString() === filters.store;
//     const matchesStatus = !filters.status || vehicle.status === filters.status;
...
//   const getStatusBadge = (status: string, isExtended: boolean) => {
//     if (isExtended) {
//       return <Badge variant="destructive" className="bg-warning text-warning-foreground">Extended Stay</Badge>;
//     }

//     switch (status) {
//       case "In":
//         return <Badge variant="default" className="bg-success">Checked In</Badge>;
//       case "Out":
//         return <Badge variant="secondary" className="bg-error">Checked Out</Badge>;
//       default:
//         return <Badge variant="outline">{status}</Badge>;
//     }
//   };
...
//                       <div className="text-sm text-gray-500">{vehicle.vendorName}</div>
//                     </div>
//                   </div>
//                 </TableCell>
//                 <TableCell>{vehicle.driverName}</TableCell>
...
//                       <Eye className="h-4 w-4" />
//                     </Button>
//                     <Button variant="ghost" size="sm" className="text-error hover:text-red-700">
//                       <LogOut className="h-4 w-4" />
//                     </Button>
//                   </div>
//                 </TableCell>
